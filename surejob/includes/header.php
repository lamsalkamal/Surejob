...
<head>
    <meta charset="utf-8" />
    <link rel="icon" href="assets/images/surejob-logo.png" />
    ...
    <script async defer crossorigin="anonymous"
        src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v6.0&appId=711797392550624&autoLogAppEvents=1">
    </script>

    <title><?php echo isset($title) ? "$title - SureJob" : "SureJob"; ?>
    </title>
</head>

<body class="jp-user-panel">